...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-auto border-t border-border-interior bg-surface-container-low">
      <div className="flex flex-wrap items-center justify-between gap-space-md px-3 py-space-md font-data-mono text-[11px] text-on-surface-variant md:px-space-xl">
